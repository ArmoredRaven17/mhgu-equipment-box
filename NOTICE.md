...
[scripts/build-data.mjs](scripts/build-data.mjs) from the data files of the
[mhgu-editor](https://github.com/AHumphrey17/mhgu-editor) project. Only the
...
database, by way of the mhgu-editor project's data files. Kiranico does not
